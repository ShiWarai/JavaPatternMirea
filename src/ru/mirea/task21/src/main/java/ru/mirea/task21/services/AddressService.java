...
import ru.mirea.task21.repositories.AddressRepository;
import ru.mirea.task21.tables.Address;
...
public class AddressService implements TableService<Address>{
    ...
    @Autowired
    AddressService(AddressRepository addressRepository, EmailService emailService) {
    ...
    public void createEntity(Address address) {
        ...
        emailService.sendNotification(address);
    }
