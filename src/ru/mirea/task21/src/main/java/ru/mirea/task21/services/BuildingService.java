...
import ru.mirea.task21.repositories.BuildingRepository;
import ru.mirea.task21.tables.Building;
...
public class BuildingService implements TableService<Building>{
    ...
    @Autowired
    BuildingService(BuildingRepository buildingRepository, EmailService emailService) {
    ...
    public void createEntity(Building building) {
        ...
        emailService.sendNotification(building);
    }
